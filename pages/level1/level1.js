...
Page({
  ...
  onLoad: function (options) {
    ...
    var that=this;
    const postData={"level":"1"};
    const res={
      "state": "200",
      "message": "获取瑜伽列表成功",
      // "data": [{"model": "yogaMaster.yoga", "pk": "ayoga", "fields": {"level": 1, "video": "avideourl"}},{"model": "yogaMaster.yoga", "pk": "byoga", "fields": {"level": 1, "video": "bvideourl"}}]    "data": "[{"model": "yogaMaster.yogaimage", "pk": 3, "fields": {"yogaName": "半月式", "level": 1, "imgDescription": "nice", "image": "yoga/1.jpg"}}, {"model": "yogaMaster.yogaimage", "pk": 4, "fields": {"yogaName": "半月式", "level": 1, "imgDescription": "nice", "image": "yoga/2.jpg"}}]"      
      "data": [
